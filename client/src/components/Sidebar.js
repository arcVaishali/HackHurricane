                ...
                >
                  ...
                  <li>
                    ...
                    >
                      <li class="w-100">
                        <a href="#" class="nav-link px-0">
                          {" "}
                          <span class="d-none d-sm-inline">Challenge 1</span> 1
                        </a>
                      </li>
                      <li>
                        <a href="#" class="nav-link px-0">
                          {" "}
                          <span class="d-none d-sm-inline">Challenge 2</span> 2
                        </a>
                      </li>
                      <li>
                        <a href="#" class="nav-link px-0">
                          {" "}
                          <span class="d-none d-sm-inline">Challenge 3</span> 3
                        </a>
                      </li>
                      <li>
                        <a href="#" class="nav-link px-0">
                          {" "}
                          <span class="d-none d-sm-inline">Challenge 4</span> 4
                        </a>
                      </li>
                    </ul>
                  </li>
                  <li>
                    <a href="#" class="nav-link px-0 align-middle">
                      ...
                      <span class="ms-1 d-none d-sm-inline">To do list</span>{" "}
                    </a>
                  </li>
                </ul>
